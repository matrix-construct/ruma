...
pub struct Response {
    ...
    /// service.
    ///
    /// These are syntactically the same as the list of policies that the server can show on registration (<https://spec.matrix.org/v1.19/client-server-api/#terms-of-service-at-registration>).
    ///
