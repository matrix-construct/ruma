...
impl ConditionalPushRule {
    ...
    pub fn master() -> Self {
        Self {
            ...
            default: true,
            enabled: false,
            rule_id: PredefinedOverrideRuleId::Master.as_str().into(),
    ...
    pub fn suppress_notices() -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::SuppressNotices.as_str().into(),
    ...
    pub fn invite_for_me(user_id: &UserId) -> Self {
        Self {
            actions: vec![Notify, SetTweak(Tweak::Sound(SoundTweakValue::Default))].into(),
            default: true,
            enabled: true,
    ...
    pub fn tombstone() -> Self {
        Self {
            actions: vec![Notify, SetTweak(Tweak::Highlight(HighlightTweakValue::Yes))].into(),
            default: true,
            enabled: true,
...
impl ConditionalPushRule {
    ...
    pub fn call() -> Self {
        Self {
            ...
            .into(),
            actions: vec![Notify, SetTweak(Tweak::Sound("ring".into()))].into(),
        }
    }
