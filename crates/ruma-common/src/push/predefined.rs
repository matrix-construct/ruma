...
impl ConditionalPushRule {
    ...
    pub fn master() -> Self {
        Self {
            ...
            default: true,
            enabled: false,
            rule_id: PredefinedOverrideRuleId::Master.to_string().into(),
    ...
    pub fn suppress_notices() -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::SuppressNotices.to_string().into(),
    ...
    pub fn invite_for_me(user_id: &UserId) -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::InviteForMe.as_str().into(),
            conditions: vec![
    ...
    pub fn member_event() -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::MemberEvent.as_str().into(),
    ...
    pub fn is_user_mention(user_id: &UserId) -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::IsUserMention.as_str().into(),
    ...
    pub fn contains_display_name() -> Self {
        ...
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::ContainsDisplayName.as_str().into(),
            conditions: vec![ContainsDisplayName].into(),
        }
    }
    ...
    pub fn tombstone() -> Self {
        Self {
            actions: vec![Notify, SetTweak(Tweak::Highlight(true))].into(),
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::Tombstone.as_str().into(),
            conditions: vec![
    ...
    pub fn is_room_mention() -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::IsRoomMention.as_str().into(),
            conditions: vec![
    ...
    pub fn roomnotif() -> Self {
        ...
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::RoomNotif.as_str().into(),
            conditions: vec![
    ...
    pub fn reaction() -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::Reaction.as_str().into(),
    ...
    pub fn server_acl() -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::RoomServerAcl.as_str().into(),
            conditions: vec![
    ...
    pub fn suppress_edits() -> Self {
        Self {
            ...
            default: true,
            enabled: true,
            rule_id: PredefinedOverrideRuleId::SuppressEdits.as_str().into(),
    ...
    pub fn poll_response() -> Self {
        Self {
            rule_id: PredefinedOverrideRuleId::PollResponse.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![EventPropertyIs {
                key: "type".to_owned(),
...
impl PatternedPushRule {
    ...
    pub fn contains_user_name(user_id: &UserId) -> Self {
        #[allow(deprecated)]
        Self {
            rule_id: PredefinedContentRuleId::ContainsUserName.as_str().into(),
            enabled: true,
            default: true,
...
impl ConditionalPushRule {
    ...
    pub fn call() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::Call.as_str().into(),
            default: true,
            enabled: true,
    ...
    pub fn encrypted_room_one_to_one() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::EncryptedRoomOneToOne.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![
    ...
    pub fn room_one_to_one() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::RoomOneToOne.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![
                RoomMemberCount { is: RoomMemberCountIs::from(js_int::uint!(2)) },
    ...
    pub fn message() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::Message.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![EventMatch { key: "type".into(), pattern: "m.room.message".into() }]
                .into(),
            actions: vec![Notify, SetTweak(Tweak::Highlight(false))].into(),
        }
    }
    ...
    pub fn encrypted() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::Encrypted.as_str().into(),
            default: true,
            enabled: true,
    ...
    pub fn poll_start_one_to_one() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::PollStartOneToOne.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![
                RoomMemberCount { is: RoomMemberCountIs::from(js_int::uint!(2)) },
            ...
            .into(),
            actions: vec![Notify, SetTweak(Tweak::Sound("default".into()))].into(),
        }
    }
    ...
    pub fn poll_start() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::PollStart.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![EventPropertyIs {
                key: "type".to_owned(),
    ...
    pub fn poll_end_one_to_one() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::PollEndOneToOne.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![
                RoomMemberCount { is: RoomMemberCountIs::from(js_int::uint!(2)) },
    ...
    pub fn poll_end() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::PollEnd.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![EventPropertyIs {
                key: "type".to_owned(),
    ...
    pub fn unsubscribed_thread() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::UnsubscribedThread.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![ThreadSubscription { subscribed: false }].into(),
            actions: Default::default(),
        }
    }
    ...
    pub fn subscribed_thread() -> Self {
        Self {
            rule_id: PredefinedUnderrideRuleId::SubscribedThread.as_str().into(),
            default: true,
            enabled: true,
            conditions: vec![ThreadSubscription { subscribed: true }].into(),
            actions: vec![Notify, SetTweak(Tweak::Sound("default".into()))].into(),
        }
    }
}
...
mod tests {
    ...
    fn update_with_server_default() {
        ...
        let override_ = [
            ...
            assign!(ConditionalPushRule::master(), { enabled: true, actions: vec![Action::Notify].into()}),
            // User-defined push rule.
            ConditionalPushRuleInit {
                actions: Default::default(),
                default: false,
                enabled: false,
                rule_id: user_rule_id.into(),
                conditions: Default::default(),
            }
            .into(),
